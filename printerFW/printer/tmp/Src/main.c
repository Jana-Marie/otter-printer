...
int main(void)
{
  ...
  for (uint16_t i = 0; i < data_len - 9; i += 16) {
    ...
    my_data_buf[i + 2]  = 0b0110000000100000;
    my_data_buf[i + 3]  = 0b0110000000001001;
    my_data_buf[i + 4]  = 0b0110010000001000;
    my_data_buf[i + 5]  = 0b0110000000000011;
    my_data_buf[i + 6]  = 0b0110000010000010;
    my_data_buf[i + 7]  = 0b0110000010010001;
    my_data_buf[i + 8]  = 0b0110000010010000;
